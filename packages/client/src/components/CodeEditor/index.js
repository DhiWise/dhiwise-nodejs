    ...
    return (
      <div
        ...
        className={`overflow-hidden relative h-full ${
          imageShow && 'flex items-center justify-center p-4'
        } ${className} ${readOnly ? 'readonlyEditor' : ''}`}
        onKeyDown={(e) => {
          // to stop copy paste
          if (readOnly) {
            e.preventDefault();
      ...
      >
        {imageShow && imageSource && fileType === EXTENSION_TYPE.IMAGE ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="w-7/12 p-3 text-lg text-center xxl:text-xl xxl:w-5/12">
              <div className="w-24 h-24 m-auto mb-3 xxl:w-28 xxl:h-28 xxl:mb-10">
