...
export const ErrorList = memo(({ isError, isWarring, error, attribute }) => {
  if (!error) {
    return <NoError />;
  }
  return (
    ...
    <div>
      ...
      >
        ...
        <Tabs selectedTabClassName={TabCSs.selectTab}>
          <TabList
            className={`${TabCSs.tabHead} flex justify-between items-center`}
          >
            <div className="flex items-center">
              <Tab
                className={`${TabCSs.tabTitle} flex items-center`}
                onClick={() =>
                  handletabChange &&
                  handletabChange(MODEL_ERROR_TABS.JSON_ERROR)
                }
              >
                JSON error
              ...
              {isModelTab && (
                <Tab
                  ...
                  onClick={() =>
                    handletabChange &&
                    handletabChange(MODEL_ERROR_TABS.MODEL_ERROR)
                  }
                >
                  Model error
